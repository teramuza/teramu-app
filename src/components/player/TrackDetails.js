...
const TrackDetails = ({ title, artist, onAddPress, onMorePress, onTitlePress, onArtistPress }) => (
    ...
    <View style={styles.container}>
        <TouchableOpacity onPress={onAddPress}>
            <Image style={styles.button} source={require('../../assets/icon/ic_add_circle_outline_white.png')} />
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={onMorePress}>
            <View style={styles.moreButton}>
                <Image style={styles.moreButtonIcon} source={require('../../assets/icon/ic_more_horiz_white.png')} />
            </View>
        </TouchableOpacity>
    </View>
);
